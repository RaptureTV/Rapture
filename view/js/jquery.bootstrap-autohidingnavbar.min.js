...
!(function (s, t, e, o) {
    ...
    function w(t) {
        ...
        //         {
        //             top:
        //                 0 * parseInt(t.element.css("height"), 10) +
        //                 t.settings.navbarOffset,
        //         },
        //         { queue: !1, duration: t.settings.animationDuration }
        //     );
        //     try {
        //         s(
    ...
    function O(t) {
        ...
        //         ),
        //     (g = !0),
        //     t.element.trigger("show.autoHidingNavbar"));
    }
    function b(t) {
            ...
            return e === o || "object" == typeof e
                ? this.each(function () {
                      s.data(this, "plugin_" + h) ||
                          s.data(this, "plugin_" + h, new p(this, e));
                  })
